...
def collect_images(raw_dir):
    """Collect all images from raw_dir/images/* and remove duplicates."""
    seen_hashes = set()
    class_images = {}

    for folder in os.listdir(raw_dir):
        images_folder = os.path.join(raw_dir, folder, "images")
...
def main():
    ...
    parser.add_argument("--raw-dir", type=str, default="datasets/raw", help="Root directory with raw dataset")
    parser.add_argument("--split-dir", type=str, default="datasets/split", help="Destination directory for splits")
